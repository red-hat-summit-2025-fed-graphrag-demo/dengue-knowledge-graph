#!/usr/bin/env python3
"""
Neo4j connection test script for OpenShift passthrough route with insecure TLS
"""
...
print("Using insecure TLS (no certificate validation)")

try:
    # Create SSL context with certificate validation disabled
    ssl_context = ssl.create_default_context()
    ssl_context.check_hostname = False
    ssl_context.verify_mode = ssl.CERT_NONE
    
    # Create driver with basic authentication and insecure TLS
